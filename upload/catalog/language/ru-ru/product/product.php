...
$_['text_stock_preorder_allowed'] = 'Предзаказ: товара сейчас нет в наличии, но его можно заказать.';
...
$_['error_product']            = "Для добавления отзыва нужно выбрать товар!";
$_['error_review_disabled']    = 'Отзывы отключены.';
$_['error_review_login']       = 'Чтобы оставить отзыв, необходимо авторизоваться.';
