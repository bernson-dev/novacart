...
$_['text_stock_preorder_confirm']     = 'Товару зараз немає в наявності, але його буде оформлено як передзамовлення.';
$_['text_stock_preorder_order_title'] = 'Передзамовлення:';
$_['text_stock_preorder_order_line']  = '%s — %d шт.';
