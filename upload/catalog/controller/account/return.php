...
class ControllerAccountReturn extends Controller {
	...
	public function info() {
		...
		if ($return_info) {
			...
			$data['date_ordered'] = date($this->language->get('datetime_format'), strtotime($return_info['date_ordered']));
			$data['date_added'] = date($this->language->get('datetime_format'), strtotime($return_info['date_added']));
