...
$_['entry_repair_schema'] = 'DB structure';

$_['help_repair_schema'] = 'If the dump is old or incomplete, the installer will create missing tables, columns, and indexes. Existing data is not deleted.';
...
$_['error_db_port'] = 'A valid database port is required (1-65535)!';
...
$_['error_sql_dump'] = 'Please select a valid SQL dump from the install directory!';
