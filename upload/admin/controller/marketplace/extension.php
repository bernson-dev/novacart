	...
	public function index() {
		...
		foreach ($files as $file) {
			...
			if ($this->user->hasPermission('access', 'extension/extension/' . $extension)) {
				$extension_files = glob(DIR_APPLICATION . 'controller/extension/' . $extension . '/*.php', GLOB_BRACE);
				...
				$data['categories'][] = array(
					'code' => $extension,
					'text' => $this->language->get('extension')->get('heading_title') . ' (' . count($extension_files) . ')',
