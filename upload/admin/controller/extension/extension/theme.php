		...
		if ($files) {
			foreach ($files as $file) {
				...
				$store_data[] = array(
					...
					'status' => $this->config->get('theme_' . $extension . '_status') ? '<span class="label label-success">' . $this->language->get('text_enabled') . '</span>' : '<span class="label label-danger">' . $this->language->get('text_disabled') . '</span>'
				);
				...
				foreach ($stores as $store) {
					$store_data[] = array(
						...
						'status' => $this->model_setting_setting->getSettingValue('theme_' . $extension . '_status', $store['store_id']) ? '<span class="label label-success">' . $this->language->get('text_enabled') . '</span>' : '<span class="label label-danger">' . $this->language->get('text_disabled') . '</span>'
					);
				}
