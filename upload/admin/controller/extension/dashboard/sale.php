...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function dashboard() {
		...
		// Получаем символы слева и справа отдельно
		$symbol_left = $this->currency->getSymbolLeft($this->config->get('config_currency'));
		$symbol_right = $this->currency->getSymbolRight($this->config->get('config_currency'));

		// Передаём всё в данные для шаблона
