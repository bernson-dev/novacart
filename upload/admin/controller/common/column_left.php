...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/attribute_bulk')) {
				$attribute[] = array(
					'name'     => $this->language->get('text_attribute_bulk'), // Перевод берётся из language-файла attribute_bulk.php
			...
			// Добавлен третий уровень меню для расширений
			if ($this->user->hasPermission('access', 'marketplace/extension')) {
				// Третий уровень: подменю для расширений
				$extensions_children = array(
				array(
				...
				array(
				'name'     => $this->language->get('text_captcha'),
				...
				// Второй уровень: пункт "Расширения" с подменю
				$marketplace[] = array(
				'name'     => $this->language->get('text_extension'),
				'href'     => '', // Оставляем пустым, так как есть подменю
			...
			if ($this->user->hasPermission('access', 'tool/dump_install')) {
				$maintenance[] = array(
				'name'     => $this->language->get('text_dump_install'),
			...
			if ($this->user->hasPermission('access', 'report/order_profit')) {
				$report[] = array(
				'name'     => $this->language->get('text_order_profit'),
