...
$_['text_drag_drop_tip']  = 'Подсказка: Вы можете перетаскивать модули внутри каждой колонки или между колонками, чтобы изменить их позицию и порядок. Используйте значок перетаскивания (<i class="fa fa-hand-grab-o"></i>) для перемещения модулей.';
