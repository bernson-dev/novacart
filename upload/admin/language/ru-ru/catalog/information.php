...
$_['button_save_new']        = 'Сохранить и добавить новую информационную страницу';

// Text
$_['text_success']           = 'Настройки сохранены!';
$_['text_list']              = 'Список информационных старниц';
$_['text_add']               = 'Добавить';
$_['text_edit']              = 'Редактировать';
$_['text_default']           = 'По умолчанию';
$_['text_keyword']           = 'Должен быть уникальным на всю систему, без пробелов и спецсимволов.';

$_['text_success_add_new']   = 'Добавлена / сохранена информационная страница: <strong class="text-primary">%s</strong>. Добавление новой записи...';
$_['text_success_created']   = 'Информационная страница добавлена: <strong class="text-primary">%s</strong>';
$_['text_success_apply']     = 'Информационная страница сохранена! Редактирование: <strong class="text-primary">%s</strong>';
