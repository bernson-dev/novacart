...
$_['text_drag_drop_tip']  = 'Tip: You can drag and drop modules within each column or between columns to change their position and order. Use the drag handle icon (<i class="fa fa-hand-grab-o"></i>) to move modules.';
