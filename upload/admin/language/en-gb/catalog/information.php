...
$_['button_save_new']        = 'Save and add new information';
...
$_['text_success_add_new']   = 'Information page created/saved: <strong class="text-primary">%s</strong>. Adding a new information...';
$_['text_success_created']   = 'Information page created: <strong class="text-primary">%s</strong>';
$_['text_success_apply']     = 'Information page saved! Editing: <strong class="text-primary">%s</strong>';
