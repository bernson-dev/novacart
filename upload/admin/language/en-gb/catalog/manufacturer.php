...
$_['button_save_new']        = 'Save and add new manufacturer';
...
$_['text_success_add_new']   = 'Manufacturer created/saved: <strong class="text-primary">%s</strong>. Adding a new...';
$_['text_success_created']   = 'Manufacturer created: <strong class="text-primary">%s</strong>';
$_['text_success_apply']     = 'Manufacturer saved! Editing: <strong class="text-primary">%s</strong>';
