...
$_['text_geocode_empty']           = 'Enter the address to receive the geocode';
...
$_['text_logo_fallback_name']      = 'Title';
$_['entry_logo_fallback_mode']     = 'Default logo mode';
$_['help_logo_fallback_mode']      = 'Used if there is no logo image';
...
$_['entry_svg_icon']               = 'SVG icon for favicon';
$_['entry_favicon_original']       = 'Use original color';
$_['entry_favicon_color']          = 'Favicon color';

$_['help_svg_icon']                = 'Select an SVG file for favicon generation.';
$_['help_favicon_original']        = 'If enabled, the original SVG color will be used.';
$_['error_svg_icon']               = 'A valid SVG file must be selected.';
