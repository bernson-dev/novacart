...
class ModelExtensionPaymentTwocheckoutApi extends Model {
	...
	public function install() {
		$this->db->query("
            CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "twocheckout_api` (
	...
	public function uninstall() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "twocheckout_api`;");
	}
	...
	private function updateRefundTransaction($order_id, $comment) {
		$this->db->query("UPDATE `" . DB_PREFIX . "twocheckout_api` SET 
