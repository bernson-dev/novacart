...
// Cache
$_['cache_engine'] = 'file'; // apc, apcu, file, fastfile, smartcache, mem, memcached or redis
$_['cache_expire'] = 3600;
...
// Error
$_['error_display'] = true; // You need to change this to false on a live site. Разрешает вывод ошибок
$_['error_log'] = true;
